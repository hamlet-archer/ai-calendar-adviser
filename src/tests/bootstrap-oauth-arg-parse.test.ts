 ...
 * script once (G6.5b operator_observable).
 *
 * Mirrors ai-comms-adviser's `bootstrap-oauth-arg-parse.test.ts` (G2);
 * the ai-calendar-adviser variant is narrower (single subject, single
...
describe('bootstrap-oauth — subject coverage (single subject, calendar-adviser variant)', () => {
